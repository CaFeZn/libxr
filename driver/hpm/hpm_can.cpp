...
#if LIBXR_HPM_CAN_SUPPORTED
HPMCAN* HPMCAN::instance_map_[HPMCAN::kMaxInstances] = {};
#endif
...
#if LIBXR_HPM_CAN_SUPPORTED
can_node_mode_t HPMCAN::ConvertMode(const CAN::Mode& mode)
{
...
void HPMCAN::ApplyLowLevelTiming(const CAN::BitTiming& src, can_bit_timing_param_t& dst)
{
...
void HPMCAN::BuildTxFrame(const ClassicPack& pack, can_transmit_buf_t& frame)
{
...
bool HPMCAN::BuildRxPack(const can_receive_buf_t& frame, ClassicPack& pack)
{
...
CAN::ErrorID HPMCAN::ConvertProtocolError(uint8_t error_kind)
{
  switch (error_kind)
  {
...
uint32_t HPMCAN::GetClockFreq() const
{
#if LIBXR_HPM_CAN_SUPPORTED
...
#if LIBXR_HPM_CAN_SUPPORTED
void HPMCAN::ProcessRxBuffer(bool in_isr)
{
